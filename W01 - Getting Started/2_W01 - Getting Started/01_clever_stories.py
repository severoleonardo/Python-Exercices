# Added the capitalize() function to the exclamation variable so that the first letter of the string is capitalized.
# Added more story options for the user to choose from.

"""
W01 Prove: Project - Clever Stories
