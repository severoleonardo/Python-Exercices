...
#The Mystery of the Haunted Mansion
    "It was a dark and stormy night when I decided to explore the abandoned mansion \non the hill. As I entered the old building, I heard a loud {exclamation} coming from upstairs. Without hesitation, \nI grabbed my {adjective} {animal} and slowly made my way up the stairs. Suddenly, \nI saw a shadow move and I knew that something was not right. I quickly {first_verb} \nto the nearest room and hid behind a {second_verb}. That's when I saw it... a \n{third_verb} in the corner of the room!",
    
#The Quest for the Golden Dragon
    "In a far-off land, there was a legendary treasure hidden away in a cave guarded by a fearsome \n{animal}. I knew I had to have it, so I set out on a quest to find the cave. As I journeyed through the mountains, I came across a \n{adjective} \n{exclamation} who offered to help me on my quest. Together, we climbed the highest peaks and crossed the widest rivers until we finally found the cave. But as we approached, the \n{animal} appeared and tried to {first_verb} us. With quick thinking, we {second_verb} and \n{third_verb} the creature out of the way, and we finally reached the treasure."
"""

"""
# I. SAMPLE OUTPUT
print("Please enteder the follwing:")
...
#displays the story with the user's words
print(f"\nYour story is: \n\nThe other day, I was really in trouble. It all started when I saw a very \n{adjective} {animal} {first_verb} down the hallway. {exclamation.capitalize()}! I yelled. But all \nI could think to do was to {second_verb} over and over. Miraculously, \nthat caused it to stop, but not before it tried to {third_verb} \nright in front of my family.")
